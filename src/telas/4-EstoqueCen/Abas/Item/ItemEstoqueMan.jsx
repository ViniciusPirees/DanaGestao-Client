...
export default function ItemEstoqueMan() {
  ...
  const criarEst = async () => {
    ...
    if (saldo.length == 0) {
      ...
      if (saldo == 0) {
        return Notificacao(["erro", `Saldo tem que ser maior que 0`]);
      }
    }
            ...
            <div className="mt-10">
              ...
              <div className="flex mt-10">
                ...
                <div className="w-[15%] mx-10">
                  ...
                  >
                    <BsFillCameraFill className="mr-2 ml-3 text-3xl"></BsFillCameraFill>Anexo
                  </button>
                  <div className="">
                    {anexofile?.size > 0 && (
              ...
              <div className="flex mt-10">
                <div className="w-[33%] mx-10">
                  ...
                  <input
                    type="number"
                    className={styleAll.inputSoW} placeholder=""
                    value={estmin}
