...
export default function TelaItem({ itens, setTelaItem }) {
    ...
    return (
        <>
            <div onClick={() => setTelaItem(false)} className=" opacity-50 bg-[#000] z-[7] fixed top-0 left-0 w-full h-full"></div>
            <div className="fixed bg-[#1f1f1f] left-0 right-0 z-[8] mx-auto top-0 bottom-0 my-auto h-fit w-[70%] p-10 border-2 rounded-md ">
                <button
                    ...
                    <table className="table rounded-lg mx-auto overflow-x-auto w-max">
                        <thead>
                            <tr className="text-xl bg-dana font-extrabold text-[#fff]">
                                ...
                                <th className="w-[8em] rounded-e-md">Qtd.</th>
                            </tr>
                        </thead>
