  ...
  return (
    <div className="flex">
      ...
      <div className="w-full pl-[8.5em] pr-10 laptop:pl-[6.5em] tablet:pl-[6.5em]">
        <Titulo titulo="Conserto Externo - Histórico" />
        {load2 && <LoadingGet></LoadingGet>}

        <div className="">
          <div className="my-9 flex">
            <h1 className="my-auto mx-4 laptop:text-[1.7em] desktop:text-[1.7em] laptop:text-2xl tablet:text-2xl font-bold">
              Data:
            </h1>
          ...
          <div className="overflow-x-auto w-full mt-10 mb-6 rounded-xl ">
            <table className="table rounded-lg mx-auto overflow-x-auto w-max">
              <thead className="">
                <tr className="text-2xl laptop:text-xl tablet:text-xl bg-dana font-extrabold">
                  <th className="w-[20em] laptop:w-[10em] tablet:w-[10em] p-3 rounded-ss-xl">
                    Data
                  </th>
                  <th className="w-[20em] laptop:w-[10em] tablet:w-[10em] p-3 ">Usuário</th>
                  <th className="w-[30em] laptop:w-[15em] tablet:w-[15em] p-3 rounded-se-xl">
                    Mensagem
                  </th>
                </tr>
              </thead>
