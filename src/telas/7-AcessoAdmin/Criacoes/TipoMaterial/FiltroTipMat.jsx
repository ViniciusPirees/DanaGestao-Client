...
export default function FiltroTipMat({ setFiltro, buscardados, setInput, changePage  }) {
  const [value, setValue] = useState("TipMatDesc");
  ...
  return (
     <div className="flex">
      <div className="mx-4 tablet:mx-0">
        ...
        >
          <option value="TipMatDesc">Tipo Material</option>
          <option value="TipMatCod">Cód. Tipo Mat.</option>
        </select>
      </div>
      <div className="flex">
        <input
