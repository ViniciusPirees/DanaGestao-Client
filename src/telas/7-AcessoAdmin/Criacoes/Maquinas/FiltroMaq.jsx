  ...
  return (
    <div className="flex">
      <div className="mx-4">
        ...
        >
          <option value="MaqCodigo">Número</option>
          <option value="MaqDescricao">Descrição</option>
          <option value="MaqDiv">Divisão</option>
          <option value="MaqSetor">Setor</option>
          <option value="MaqDivEbs">Divisão EBS</option>
        </select>
      </div>
      <div className="flex">
        <input
