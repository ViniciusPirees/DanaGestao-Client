              ...
              <table className="table table-auto rounded-lg mx-auto mb-20 w-full">
                <thead>
                  <tr className="text-2xl bg-dana font-extrabold">
                    <th className="w-[8%]">Número</th>
                    <th className="p-3 w-">Descrição</th>
                    <th className="p-3 w-[17%]">Divisão</th>
                    <th className="p-3 w-[17%]">Setor</th>
                    <th className="p-3 w-[17%]">Divisão EBS</th>
                    <th className="w-0"></th>
                    <th className="w-0"></th>
                  </tr>
                </thead>
