...
export default function FiltroUsuarios({ setFiltro, buscardados, setInput, changePage }) {
  const [value, setValue] = useState("UsuNome");
  ...
  return (
     <div className="flex">
      <div className="mx-4 tablet:mx-0">
        ...
        >
          <option value="UsuNome">Nome do Usuário</option>
          <option value="UsuCod">Cód. do Usuário</option>
        </select>
      </div>
      <div className="flex">
        <input
