...
export default function FiltroStatusPrev({ setFiltro, buscardados, setInput, changePage }) {
  const [value, setValue] = useState("StaPreDesc");
  ...
  return (
     <div className="flex">
      <div className="mx-4 tablet:mx-0">
        ...
        >
          <option value="StaPreDesc">Status</option>
          <option value="StaPreCod">Cód. Status</option>
        </select>
      </div>
      <div className="flex">
        <input
