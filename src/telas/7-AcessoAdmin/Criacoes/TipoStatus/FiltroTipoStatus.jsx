...
export default function FiltroTipoStatus({ setFiltro, buscardados, setInput, changePage }) {
  const [value, setValue] = useState("TipStaDesc");
  ...
  return (
     <div className="flex">
      <div className="mx-4 tablet:mx-0">
        ...
        >
          <option value="TipStaDesc">Tipo Status</option>
          <option value="TipStaCod">Cód. Tipo Status</option>
        </select>
      </div>
      <div className="flex">
        <input
